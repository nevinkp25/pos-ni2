                ...
                <div className="flex justify-center mt-4">
                  <svg width="327" height="41" viewBox="0 0 327 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <g clipPath="url(#clip2_4798_874)">
                      ...
                      <path d="M167.342 19.4162H167.168C166.324 19.4162 165.812 18.7513 165.812 17.8464C165.812 16.9191 166.318 16.2505 167.342 16.2505H168.259V17.0003H167.352C166.919 17.0003 166.613 17.3379 166.613 17.8542C166.613 18.4673 166.963 18.7247 167.467 18.7247H167.676L167.342 19.4162Z" fill="#016FD0"/>
