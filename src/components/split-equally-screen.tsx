          ...
          <div className="flex-1 overflow-y-auto pb-10">
            ...
            <div className="px-6 space-y-6">
              ...
              <div className="bg-white rounded-[32px] p-6 shadow-[0_20px_60px_rgba(0,0,0,0.05)] border border-gray-50 space-y-4">
                <div className="flex justify-between items-center text-[15px] font-black"><span className="text-[#94a3b8] uppercase">Bill Amount</span><CurrencyAmount amount={shareAmount} weight="bold" className="text-[14px] text-[#1a1c2e] tabular-nums" /></div>
